...
class MyProfileView(generics.RetrieveUpdateAPIView):
    """Patient's own maternal profile. Auto-created on first access."""
...
def models_q(search):
    ...
    return Q(patient_code__icontains=search) | Q(user__username__icontains=search) | Q(user__full_name__icontains=search)
