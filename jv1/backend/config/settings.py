...
SECRET_KEY = os.getenv("SECRET_KEY", "dev-only-insecure-key-change-me-32chars")
...
SPARROW_SMS_TOKEN = os.getenv("SPARROW_SMS_TOKEN", "").strip()
SPARROW_SMS_FROM = os.getenv("SPARROW_SMS_FROM", "").strip()
